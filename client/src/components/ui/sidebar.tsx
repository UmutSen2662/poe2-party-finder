/** biome-ignore-all lint/a11y/useButtonType: standart */
...
function SidebarProvider({
  ...
  const setOpen = React.useCallback(
    (value: boolean | ((value: boolean) => boolean)) => {
      ...
      // biome-ignore lint/suspicious/noDocumentCookie: standart
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "fixed inset-y-0 z-10 flex h-svh w-(--sidebar-width) transition-[left,right,width] duration-200 ease-in-out",
          side === "left"
  ...
  return (
    <Tooltip>
      ...
      <TooltipPositioner side="right" align="center">
        <TooltipContent hidden={state !== "collapsed"} {...tooltip} />
      </TooltipPositioner>
    </Tooltip>
  );
}
