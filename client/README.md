...
4. **Styling:** We use Tailwind CSS v4. All theme variables, base styles, and Tailwind configurations have been explicitly consolidated into `shared/src/styles/theme.css` which serves as the single source of truth for the entire monorepo's design system. This file is imported by both the client and the website, keeping global styles clean and preventing UI conflicts.
